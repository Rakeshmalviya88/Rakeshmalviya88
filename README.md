...
Currently focused on strengthening my **software engineering fundamentals, backend development, and problem-solving skills** while building real-world projects.
...
**Frontend**
`React.js` `HTML` `CSS` `Material UI` `Bootstrap`
